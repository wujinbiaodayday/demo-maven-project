...
public class UniqueCodeGenerator {
    //缓存最近生成的100个结尾4位序列码
    private static AutoTuningLRUCache<String, String> replCodeCache = new AutoTuningLRUCache<String, String>("purchaseCodeCache", 100);
    ...
    public static String getUniquCode() {
        ...
        int repeatCount = 1;
        while (replCodeCache.containsKey(endCode)) {
